...
class TestEnrichAbuseIPDB:
    ...
    @classmethod
    def setup_class(cls):
        """Set up the AbuseIPDB client for tests."""
        cls.client = AbuseIPDBClient()

    def test_enrich_abuseipdb_returns_string(self, abuseipdb_normalized_data):
        """Test that enrich_abuseipdb returns a string."""
        result = self.client.enrich_ip(abuseipdb_normalized_data)
...
class TestEnrichIPInfo:
    ...
    @classmethod
    def setup_class(cls):
        """Set up the IPInfo client for tests."""
        cls.client = IPInfoClient()

    def test_enrich_ipinfo_returns_string(self, ipinfo_normalized_data):
        """Test that enrich_ipinfo returns a string."""
        result = self.client.enrich_ip(ipinfo_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichIPVirusTotal:
    ...
    @classmethod
    def setup_class(cls):
        """Set up the VirusTotal client for tests."""
        cls.client = VirusTotalClient()
    ...
    def test_enrich_ip_virustotal_returns_string(self, ip_virustotal_normalized_data):
        ...
        result = self.client.enrich_ip(ip_virustotal_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichDomainVirusTotal:
    ...
    def test_enrich_domain_virustotal_returns_string(
        ...
        result = self.client.enrich_domain(domain_virustotal_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichFileHashVirusTotal:
    ...
    def test_enrich_file_hash_virustotal_returns_string(
        ...
        result = self.client.enrich_file_hash(file_hash_virustotal_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichIPAlienVault:
    ...
    @classmethod
    def setup_class(cls):
        """Set up the AlienVault client for tests."""
        cls.client = AlienVaultClient()
    ...
    def test_enrich_ip_alienvault_returns_string(self, ip_alienvault_normalized_data):
        ...
        result = self.client.enrich_ip(ip_alienvault_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichDomainAlienVault:
    ...
    def test_enrich_domain_alienvault_returns_string(
        ...
        result = self.client.enrich_domain(domain_alienvault_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichURLScan:
    ...
    @classmethod
    def setup_class(cls):
        """Set up the URLScan client for tests."""
        cls.client = URLScanClient()

    def test_enrich_urlscan_returns_string(self, urlscan_normalized_data):
        """Test that enrich_urlscan returns a string."""
        result = self.client.enrich_url(urlscan_normalized_data)
        assert isinstance(result, str)
...
class TestEnrichShodan:
    ...
    @classmethod
    def setup_class(cls):
        """Set up the Shodan client for tests."""
        cls.client = ShodanClient()

    def test_enrich_shodan_returns_string(self, shodan_normalized_data):
        result = self.client.enrich_ip(shodan_normalized_data)
        assert isinstance(result, str)
...
class TestCombinedEnrichment:
    ...
    def test_combined_enrichment_returns_string(
        ...
        result = InvestigationClient().combined_enrichment(
    ...
    def test_combined_enrichment_contains_header(self, abuseipdb_normalized_data):
        ...
        result = InvestigationClient().combined_enrichment(abuseipdb_data=abuseipdb_normalized_data)
    ...
    def test_combined_enrichment_contains_ipinfo_section(self, ipinfo_normalized_data):
        ...
        result = InvestigationClient().combined_enrichment(ipinfo_data=ipinfo_normalized_data)
    ...
    def test_combined_enrichment_contains_vt_ip_section(
        ...
        result = InvestigationClient().combined_enrichment(ip_virustotal_data=ip_virustotal_normalized_data)
    ...
    def test_combined_enrichment_contains_urlscan_section(
        ...
        result = InvestigationClient().combined_enrichment(urlscan_data=urlscan_normalized_data)
        assert "URLSCAN.IO ANALYSIS" in result
...
class TestEnrichmentConsistency:
    ...
    @classmethod
    def setup_class(cls):
        """Set up clients for enrichment functions."""
        cls.abuseipdb_client = AbuseIPDBClient()
        cls.ipinfo_client = IPInfoClient()
        cls.virustotal_client = VirusTotalClient()
        cls.alienvault_client = AlienVaultClient()
        cls.urlscan_client = URLScanClient()
        cls.shodan_client = ShodanClient()
    ...
    def test_all_enrichments_return_strings(
        ...
        domain_alienvault_normalized_data,
        urlscan_normalized_data,
        shodan_normalized_data,
    ):
        """Test that all enrichment functions return strings."""
        results = [
            AbuseIPDBClient().enrich_ip(abuseipdb_normalized_data),
            IPInfoClient().enrich_ip(ipinfo_normalized_data),
            VirusTotalClient().enrich_ip(ip_virustotal_normalized_data),
            VirusTotalClient().enrich_domain(domain_virustotal_normalized_data),
            VirusTotalClient().enrich_file_hash(file_hash_virustotal_normalized_data),
            AlienVaultClient().enrich_ip(ip_alienvault_normalized_data),
            AlienVaultClient().enrich_domain(domain_alienvault_normalized_data),
            URLScanClient().enrich_url(urlscan_normalized_data),
            ShodanClient().enrich_ip(shodan_normalized_data),
        ]
    ...
    def test_all_enrichments_contain_links(
        ...
        results = [
            (AbuseIPDBClient().enrich_ip(abuseipdb_normalized_data), "abuseipdb.com"),
            (IPInfoClient().enrich_ip(ipinfo_normalized_data), "ipinfo.io"),
            (VirusTotalClient().enrich_ip(ip_virustotal_normalized_data), "virustotal.com"),
            (
                VirusTotalClient().enrich_domain(domain_virustotal_normalized_data),
                "virustotal.com",
            ),
            ...
            (AlienVaultClient().enrich_ip(ip_alienvault_normalized_data), "otx.alienvault.com"),
            (
                AlienVaultClient().enrich_domain(domain_alienvault_normalized_data),
                "otx.alienvault.com",
            ),
            (URLScanClient().enrich_url(urlscan_normalized_data), "urlscan.io"),
            (ShodanClient().enrich_ip(shodan_normalized_data), "shodan.io"),
        ]
